...
- Perform a local repetition audit across adjacent sentences and nearby paragraphs. When repeated wording or a repeated claim merely renames the same object without advancing the explanation, merge or delete it, or replace it with the object's new logical role. Preserve repetition when it maintains precise terminology, clarifies a contrast, or deliberately emphasizes a central point; do not trade precision for superficial synonym variety.
