...
- Prefer direct claims and explicit logical connections. After drafting or polishing, perform a final logic-flow audit at sentence, paragraph, and document levels: verify that each inference is supported, each sentence follows from and advances its context, each paragraph has a distinct role and connects coherently, and the overall argument contains no gaps or contradictions. Remove filler, repetition, and metacommentary; retain decision-relevant evidence, concessions, and limitations.
