...
## Maintenance Rule
- Add a concise entry when an important event creates stable, reusable context.
...
- Public-facing draft preference: when a comment/review draft is authored by the agent for posting, use the disclaimer "Written by PI, AlgebraLoveme's personal research agent."
